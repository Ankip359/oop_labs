...
namespace laba4
{
    ...
    class ESet
    {
        ...
        {
            int[] concatArr = new int[obj1.array.Length + obj2.array.Length];
            for (int i = 0; i < obj1.array.Length; i++)
            {
                concatArr[i] = obj1.array[i];
            }
            for (int i = 0; i < obj2.array.Length; i++)
            {
                concatArr[obj1.array.Length+i] = obj2.array[i];
            }
    ...
    internal class Program
    {
        public static void Main(string[] args)
        {
            ...
            string numStr = "aaaaaallo3daas545jka 89 9ds sd";
